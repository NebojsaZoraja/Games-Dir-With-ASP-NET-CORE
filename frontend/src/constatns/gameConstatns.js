...
export const GAME_DETAILS_ADMIN_REQUEST = 'GAME_DETAILS_ADMIN_REQUEST';
export const GAME_DETAILS_ADMIN_SUCCESS = 'GAME_DETAILS_ADMIN_SUCCESS';
export const GAME_DETAILS_ADMIN_FAIL = 'GAME_DETAILS_ADMIN_FAIL';
